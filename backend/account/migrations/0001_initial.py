    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_school', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users', to='school.school')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
                ('place', models.ManyToManyField(blank=True, related_name='teacher_profiles', to='config.place', verbose_name='指導可能場所')),
